...
class NavigationSlideItemView(
    ...
    private val background = view.findViewById<ConstraintLayout>(R.id.cl_navigation_item_background)
    ...
    fun open() {
        background.setBackgroundResource(R.drawable.bg_menu_item)
        label.visibility = View.VISIBLE
    }

    fun close() {
        background.setBackgroundResource(R.drawable.bg_menu_item_collapsed)
